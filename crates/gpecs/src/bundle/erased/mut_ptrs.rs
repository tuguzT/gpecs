...
use crate::{
    ...
    bundle::{
        ...
        erased::{
            ErasedArchetypeIterator, ErasedArchetypeKind, ErasedBundleKind, ErasedBundleMutRefs,
            ErasedBundlePtrs, ErasedBundlePtrsIter, ErasedBundleRefs, IntoErasedArchetypeIterator,
        },
    },
    component::{
        erased::{

...
use crate::{
    ...
    bundle::{
        ...
        erased::{
            ErasedArchetypeKind, ErasedBundleMutPtrs, ErasedBundleRefs, ErasedBundleRefsIter,
        },
    },
    component::{
...
//         let entries = unsafe { ErasedBundleRefsIter::from_inner(inner.into_iter()) };
...
impl<D> FusedIterator for ErasedBundleMutRefsIter<'_, D>
where

...
use crate::{
    ...
    bundle::{
        ...
        erased::{
            ErasedArchetypeIterator, ErasedArchetypeKind, ErasedBundleMutPtrs,
            ErasedBundleMutSlices, ErasedBundleSlicePtrs, ErasedBundleSlicePtrsIter,
            ErasedBundleSlices, IntoErasedArchetypeIterator,
        },
    },
    component::{
        erased::{

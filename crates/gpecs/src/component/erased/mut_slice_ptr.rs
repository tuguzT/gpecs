...
pub struct ErasedComponentMutSlicePtr<T = *mut MaybeUninit<u8>> {
    ...
    T: MutSliceItemPtr,
{
    ...
    #[inline]
    pub fn cast_const(self) -> ErasedComponentSlicePtr<CastConstPtr<T>> {
        let Self {
            component_id,
            fields,
        } = self;
    ...
    #[inline]
    pub unsafe fn deref<'a>(self) -> ErasedComponentSlice<'a, CastConstPtr<T>> {

    ...
    P: ConstSliceItemPtr,
{
    ...
    pub fn iter(
        &'a self,
    ) -> ErasedBundleRefsIter<'a, FieldLayoutsIter<'a, D>, P, BufferOffsetsFromLayout> {
        let Self { inner } = self;
    ...
    P: ConstSliceItemPtr,
{
    ...
    type IntoIter = ErasedBundleRefsIter<'a, FieldLayoutsIter<'a, D>, P, BufferOffsetsFromLayout>;
...
{
    #[inline]
    pub fn iter(&'a self) -> ErasedBundleRefsIter<'a, FieldLayoutsIter<'a, D>, P, F> {
        let Self { inner } = self;
...
{
    type Item = ErasedComponentRef<'a, P>;
    type IntoIter = ErasedBundleRefsIter<'a, FieldLayoutsIter<'a, D>, P, F>;

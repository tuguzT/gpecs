...
{
    #[inline]
    pub fn iter(&'a self) -> ErasedBundleSlicePtrsIter<D::OutputIter, P, BufferOffsetsFromLayout> {
        let Self { inner } = self;
    ...
    P: ConstSliceItemPtr,
{
    ...
    type IntoIter = ErasedBundleSlicePtrsIter<D::OutputIter, P, BufferOffsetsFromLayout>;

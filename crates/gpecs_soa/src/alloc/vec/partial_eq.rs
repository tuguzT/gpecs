...
partial_eq_impl! { [] SoaVec<T>, Self where T: }
partial_eq_impl! { [] SoaVec<T>, SoaSlices<'_, '_, T> where T: }
partial_eq_impl! { [] SoaVec<T>, SoaSlicesMut<'_, '_, T> where T: }
...
partial_eq_impl! { [] SoaSlices<'_, '_, T>, SoaVec<T> where T: }
partial_eq_impl! { [] SoaSlicesMut<'_, '_, T>, SoaVec<T> where T: }

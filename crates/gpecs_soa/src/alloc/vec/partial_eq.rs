...
partial_eq_impl! { [] SoaVec<T>, Self }
partial_eq_impl! { [] SoaVec<T>, SoaSlices<'_, '_, T> }
partial_eq_impl! { [] SoaVec<T>, SoaSlicesMut<'_, '_, T> }
...
partial_eq_impl! { [] SoaSlices<'_, '_, T>, SoaVec<T> }
partial_eq_impl! { [] SoaSlicesMut<'_, '_, T>, SoaVec<T> }

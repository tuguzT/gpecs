...
partial_ord_impl! { [] SoaVec<T>, Self }
partial_ord_impl! { [] SoaVec<T>, SoaSlices<'_, '_, T> }
partial_ord_impl! { [] SoaVec<T>, SoaSlicesMut<'_, '_, T> }
...
partial_ord_impl! { [] SoaSlices<'_, '_, T>, SoaVec<T> }
partial_ord_impl! { [] SoaSlicesMut<'_, '_, T>, SoaVec<T> }

...
use crate::traits::WithFieldDescriptors;

type Inner<'ctx, T> = <T as WithFieldDescriptors>::FieldDescriptors<'ctx>;

/// Type wrapper for [field descriptors](WithFieldDescriptors::FieldDescriptors)
/// which is covariant over generic lifetime.
#[repr(transparent)]
pub struct FieldDescriptors<'ctx, T>
where
    T: WithFieldDescriptors + ?Sized,
{
...
where
    T: WithFieldDescriptors + ?Sized,
{
    /// Creates self from the [field descriptors](WithFieldDescriptors::FieldDescriptors).
    #[inline]
    ...
    /// Retrieves a reference of [field descriptors](WithFieldDescriptors::FieldDescriptors).
    #[inline]
    ...
    /// Retrieves a mutable reference of [field descriptors](WithFieldDescriptors::FieldDescriptors).
    #[inline]
    ...
    /// Retrieves the [field descriptors](WithFieldDescriptors::FieldDescriptors).
    #[inline]

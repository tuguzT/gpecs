...
\[[1](/bibliography/Data%20Structures%20for%20Game%20Developers%20The%20Slot%20Map.md), [2](/bibliography/slot_map%20Container%20in%20C++.md)],
which is actually built on top of [sparse set](/bibliography/Using%20Uninitialized%20Memory%20for%20Fun%20and%20Profit.md).
...
![Sparse set structure](sparse-set-structure.png)
